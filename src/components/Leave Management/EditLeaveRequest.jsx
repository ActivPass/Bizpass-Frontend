  ...
  return (
    <div className="p-1 sm:p-5">
      {/* <div className="flex items-center align-middle">
          ...
          <GoChevronRight className="sm:text-xl opacity-40 " />
          <div className=" text-xs sm:text-base ">Edit Leave Request</div>
        </div> */}
      <NavHeader
        current={{ name: "Edit Leave Request app" }}
        previous={[
          { name: "Home", link: "/" },
      ...
      <div className=" p-6 bg-gray-100 rounded-lg shadow-lg mt-5">
        <h2 className="text-2xl font-semibold mb-4"> Edit Leave Request</h2>
