    ...
    <div className="p-1 sm:p-5 ">
      <div className="flex items-center align-middle mb-5">
        <p className="text-2xl font-bold">
          Add Shift <span className="text-3xl opacity-40"> |</span>{" "}
        </p>
        &nbsp;&nbsp;
        <Link to={"/"}>
        ...
        <GoChevronRight className="sm:text-xl opacity-40 " />
        <div className=" text-xs sm:text-base ">Add Shift</div>
      </div>
      <form className="w-3/5  mx-auto border border-gray-200 rounded-lg px-5">
        <h3 className="text-xl font-bold text-center mb-10 mt-5">Add Shift</h3>
        ...
        <div className="mb-3">
          <TextField label="Add Note" multiline rows={4} variant="outlined" fullWidth />
        </div>
