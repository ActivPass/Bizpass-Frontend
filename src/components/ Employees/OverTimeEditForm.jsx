    ...
    <div className="p-1 sm:p-5 ">
      <div className="flex items-center align-middle mb-12">
        <p className="text-2xl font-bold">
          Edit Overtime <span className="text-3xl opacity-40"> |</span>{" "}
        </p>
        &nbsp;&nbsp;
        <Link to={"/"}>
        ...
        <GoChevronRight className="sm:text-xl opacity-40 " />
        <div className=" text-xs sm:text-base ">Edit Overtime</div>
      </div>
      <form onSubmit={handleSubmit} className="flex flex-col w-3/6 mx-auto border border-gray-200 rounded-lg px-5">
        <p className="text-xl font-bold text-center my-10">Edit Overtime</p>
...
export default OverTimeEditFrom
