...
export function EmployeeForm() {
  ...
  const benefits = [
    ...
    { name: "Retirement Plans", value: "retirement_plans" },
    { name: "Other (please specify", value: "others" },
  ]
  const compensation = [
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="px-4">
                <Link className="block text-blue-700 hover:underline hover:text-blue-800" to="#">
                  Code of Conduct
                </Link>
                <Link className="block text-blue-700 hover:underline hover:text-blue-800" to="#">
